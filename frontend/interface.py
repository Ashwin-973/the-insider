...
def show_backend_connection_error():
    st.error(
        f"Cannot connect to backend at {API_BASE_URL}. Make sure the FastAPI server is running."
    )


def login_page():
    st.title("🗣️ Welcome to The Insider")
...
if st.session_state.user is None:
    ...
    st.sidebar.markdown("---")
    page = st.sidebar.radio("Navigate:", ["🍳 Feed", "😶‍🌫️ Upload"])
